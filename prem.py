...
def menu():
    ...
    print((p+" ["+k+"•"+m+"•"+p+"]"+p+" ID      : \033[1;32m"+id))
    print((p+" ["+k+"•"+m+"•"+p+"]"+p+" TTL     : \033[1;32m"+ttl))
    print((p+" ["+k+"•"+m+"•"+p+"]"+p+" Joined  : \033[1;32m"+durasi))
    print((p+"\n ["+k+"01"+p+"]"+p+" Crack ID From Public/Friendlist"))
    print((p+" ["+k+"02"+p+"]"+p+" Hack ID From Like Post"))
    print((p+" ["+k+"03"+p+"]"+p+" Hack ID From Followers"))
    print((p+" ["+k+"04"+p+"]"+p+" Hack Number Phone"))
    print((p+" ["+k+"05"+p+"]"+p+" Hack Email"))
    print((p+" ["+k+"06"+p+"]"+p+" Result "))
    print((p+" ["+k+"00"+p+"]"+p+" Out "))
    choose_menu()
...
def pilihcrack(file):
  ...
  print((p+" ["+k+"01"+p+"] Api.Facebook"))
  print((p+" ["+k+"02"+p+"] Api.Facebook + TTL "))
  print((p+" ["+k+"03"+p+"] Mbasic.Facebook"))
  print((p+" ["+k+"04"+p+"] Mbasic.Facebook + TTL"))
  print((p+" ["+k+"05"+p+"] Touch.Facebook"))
  print((p+" ["+k+"06"+p+"] Touch.Facebook + TTL "))
  print((p+" ["+k+"07"+p+"] M.Facebook "))
  print((p+" ["+k+"08"+p+"] M.Facebook + TTL "))
  print((p+" ["+k+"09"+p+"] Free.Facebook "))
  print((p+" ["+k+"10"+p+"] Free.Facebook + TTL "))
  print((p+" ["+k+"00"+p+"] Back "))
  krah=input(p+"\n ["+k+"•"+m+"•"+p+"] Choose : ")
  if krah in[""]:
    print((p+" ["+k+"•"+m+"•"+p+"] Fill In The Correct"))
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					print(("   %s"%e))
					continue
				print((p+" ["+k+"•"+m+"•"+p+"] Example : contoh123,nama123,123456"))
				self.pwlist()
				break
			elif f=="d":
				try:
